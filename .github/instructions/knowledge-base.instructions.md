...
This workspace contains a three-tier knowledge base under `kb/`. When answering project questions, Copilot should consult it first, using the cheapest tier that can answer.
